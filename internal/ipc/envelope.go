...
var eventKinds = map[string]func() protocol.Event{
	"observatory_server_started": func() protocol.Event { return &protocol.ObservatoryServerStartedEvent{} },
	"observatory_snapshot":       func() protocol.Event { return &protocol.ObservatorySnapshotEvent{} },
