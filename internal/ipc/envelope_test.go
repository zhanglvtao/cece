...
func TestEventRoundTrip(t *testing.T) {
	events := []protocol.Event{
		...
		protocol.CompletionGateEvaluated{Attempt: 1, MaxAttempts: 3, Status: protocol.CompletionGateBlocked, Checks: []protocol.CompletionGateCheck{{Name: "TaskClosureGate", Status: protocol.CompletionGateBlocked}}, Next: "continue"},
